...
CLASS zcl_sat_object_search_query DEFINITION
  ...
  PUBLIC SECTION.
    ...
    DATA mv_type TYPE zsat_obj_browser_mode READ-ONLY.
    DATA mv_query TYPE string READ-ONLY.
    DATA mv_max_rows TYPE sy-tabix READ-ONLY.
    DATA mt_search_options TYPE zif_sat_ty_object_browser=>tt_search_option_values READ-ONLY.
    DATA ms_search_engine_params TYPE zif_sat_ty_object_browser=>ty_s_search_engine_params READ-ONLY.
    ...
    CLASS-METHODS parse_query_string
      IMPORTING
        ...
        is_search_engine_params TYPE zif_sat_ty_object_browser=>ty_s_search_engine_params OPTIONAL
        iv_search_type          TYPE zsat_obj_browser_mode
      RETURNING
        VALUE(rr_query)         TYPE REF TO zcl_sat_object_search_query
      RAISING
    ...
    CLASS-METHODS create_query
      IMPORTING
        ...
        is_search_engine_params TYPE zif_sat_ty_object_browser=>ty_s_search_engine_params OPTIONAL
        it_options              TYPE zif_sat_ty_object_browser=>tt_search_option_values OPTIONAL
      RETURNING
        VALUE(rr_query)         TYPE REF TO zcl_sat_object_search_query
      RAISING
        zcx_sat_object_search.
    ...
    METHODS get_options
      RETURNING
        VALUE(rt_options) TYPE zif_sat_ty_object_browser=>tt_search_option_values.
    "! <p class="shorttext synchronized" lang="en">Add search option to query</p>
    "!
    METHODS set_option
      IMPORTING
        is_option TYPE zif_sat_ty_object_browser=>ty_search_option_values.
    ...
    METHODS get_option
      ...
      RETURNING
        VALUE(rs_option) TYPE zif_sat_ty_object_browser=>ty_search_option_values.
  ...
  PRIVATE SECTION.
    ...
    METHODS constructor
      IMPORTING
        ...
        it_search_options       TYPE zif_sat_ty_object_browser=>tt_search_option_values.
    ...
    CLASS-METHODS get_search_terms
      IMPORTING
        iv_search_string      TYPE string
      RETURNING
    ...
    CLASS-METHODS extract_option
      ...
      CHANGING
        VALUE(cs_search_options) TYPE zif_sat_ty_object_browser=>ty_search
      RAISING
        zcx_sat_object_search.
    ...
    CLASS-METHODS add_option_value
      ...
      CHANGING
        ct_options TYPE zif_sat_ty_object_browser=>tt_search_option_values.
    "! <p class="shorttext synchronized" lang="en">Post validation of query options</p>
    CLASS-METHODS post_validate_options
      IMPORTING
        iv_search_type TYPE zsat_obj_browser_mode
      CHANGING
        ct_options     TYPE zif_sat_ty_object_browser=>tt_search_option_values
...
*.... CDS View options)
      ...
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_association )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_anno        )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_field       )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_type        )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_package     )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_description )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-by_extensions  )
      ( type = zif_sat_c_object_browser_mode=>cds_view option = c_search_option-max_rows       )
*.... Database table/view options
      ( type = zif_sat_c_object_browser_mode=>database_table_view option = c_search_option-by_owner       )
      ( type = zif_sat_c_object_browser_mode=>database_table_view option = c_search_option-by_package     )
      ( type = zif_sat_c_object_browser_mode=>database_table_view option = c_search_option-by_type        )
      ( type = zif_sat_c_object_browser_mode=>database_table_view option = c_search_option-by_field       )
      ( type = zif_sat_c_object_browser_mode=>database_table_view option = c_search_option-by_description )
      ( type = zif_sat_c_object_browser_mode=>database_table_view option = c_search_option-max_rows       )
*.... Package options
      ( type = zif_sat_c_object_browser_mode=>package option = c_search_option-by_owner       )
      ( type = zif_sat_c_object_browser_mode=>package option = c_search_option-by_description )
      ( type = zif_sat_c_object_browser_mode=>package option = c_search_option-max_rows       )
*.... Query options
      ( type = zif_sat_c_object_browser_mode=>query option = c_search_option-by_owner )
      ( type = zif_sat_c_object_browser_mode=>query option = c_search_option-by_select_from )
      ( type = zif_sat_c_object_browser_mode=>query option = c_search_option-by_description )
      ( type = zif_sat_c_object_browser_mode=>query option = c_search_option-max_rows )
    ).
  ENDMETHOD.

  METHOD parse_query_string.
    DATA: lt_query_tokens       TYPE TABLE OF string,
          ls_query              TYPE zif_sat_ty_object_browser=>ty_search,
...
*.. Get all possible options for the given search type
    ...
    LOOP AT lt_query_tokens ASSIGNING FIELD-SYMBOL(<lv_token>).
      ...
      ELSE.
        IF lf_query_string_found = abap_true.
          RAISE EXCEPTION TYPE zcx_sat_object_search
            EXPORTING
              textid = zcx_sat_object_search=>invalid_query_parameter
              msgv1  = |{ <lv_token> }|.
    ...
    post_validate_options(
        EXPORTING iv_search_type = iv_search_type
        CHANGING  ct_options     = ls_query-options ).
    ...
    rr_query = NEW #(
      ...
      iv_query                = iv_query
      it_search_term          = get_search_terms( ls_query-query )
  ...
  METHOD create_query.
    ...
    rr_query = NEW #(
       ...
       is_search_engine_params = is_search_engine_params
       it_search_term          = get_search_terms( iv_search_string )
  ...
  METHOD constructor.
    ...
    IF iv_search_string IS NOT INITIAL.
      mv_search_option = COND #( WHEN iv_search_string CA '+*' THEN zif_sat_c_options=>contains_pattern ELSE zif_sat_c_options=>equals ).
    ENDIF.
...
*... delete duplicate entries
  ...
  METHOD enhance_options.
    DATA: lt_package_range TYPE zif_sat_ty_object_browser=>ty_t_value_range.
