...
CLASS zcl_sat_adt_res_objs_class DEFINITION
  PUBLIC
...
CLASS zcl_sat_adt_res_objs_class IMPLEMENTATION.
  ...
  METHOD get_query_parameter.
    ...
    ev_type = zif_sat_c_object_browser_mode=>abap_class.
...
*    get_release_state_param( EXPORTING io_request = io_request  CHANGING  ct_options = et_options ).
    ...
    _get_param: zif_sat_c_object_browser=>c_search_option-by_method,
